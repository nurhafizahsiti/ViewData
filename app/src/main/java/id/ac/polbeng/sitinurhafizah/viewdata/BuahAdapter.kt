package id.ac.polbeng.sitinurhafizah.viewdata
...
import id.ac.polbeng.sitinurhafizah.viewdata.databinding.ListItemBinding
class BuahAdapter(
    private var context: Activity,
    private val dataBuah: Array<String>,
    private val dataGambar: Array<Int>
) : RecyclerView.Adapter<BuahAdapter.BuahHolder>() {override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):
        BuahHolder {
    val binding =
